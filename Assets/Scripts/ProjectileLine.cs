...
public class ProjectileLine : MonoBehaviour {
	...
	public void AddPoint() {
		...
		if(points.Count == 0){
			...
			Vector3 launchPos = Slingshot.S.launchPoint.transform.position; //Should be launchPoint.get
			Vector3 launchPosDiff = pt - launchPos;
			// _it adds a extra bit of line to aid aiming later
	...
	//Returns the location of the most recent added point
	...
	void FixedUpdate () {
		if (poi == null){
			...
			if (FollowCam.S.poi != null){
				...
				return; //Return if we didn't get a poi
			}
		}
